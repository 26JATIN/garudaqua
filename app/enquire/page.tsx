            ...
            <div className="min-h-screen bg-gray-50 dark:bg-black flex items-center justify-center px-4">
                <div className="max-w-md w-full bg-white dark:bg-[#0A0A0A] rounded-2xl shadow-xl dark:shadow-none dark:border dark:border-white/10 p-8 text-center animate-[fadeIn_0.3s_ease-out]">
                    ...
                    <div className="flex gap-3 justify-center">
                        <NavigationLink href="/products" className="px-6 py-2.5 bg-[#0369A1] text-white rounded-full hover:bg-[#0284C7] transition text-sm font-medium">
                            Browse Products
                        </NavigationLink>
                        <button
                            onClick={() => {
                                setSubmitted(false);
                                setFormData({ name: "", email: "", phone: "", company: "", city: "", state: "", product: "", quantity: "", message: "" });
                            }}
