...
const stats = [
    { label: "Total Products", value: "15", icon: "box", href: "/admin/products" },
    { label: "Categories", value: "3", icon: "grid", href: "/admin/categories" },
    { label: "Blog Posts", value: "6", icon: "doc", href: "/admin/blogs" },
    { label: "Hero Videos", value: "0", icon: "video", href: "/admin/hero-videos" },
];
    ...
    return (
        <div className="space-y-8">
            <div>
                ...
                <p className="text-gray-600 mt-1">Welcome to Garud Aqua Solution admin panel</p>
            </div>
