  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black py-12 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="h-10 w-48 bg-gray-200 dark:bg-white/10 rounded-lg mb-4 animate-pulse" />
        <div className="h-4 w-80 bg-gray-200 dark:bg-white/10 rounded mb-10 animate-pulse" />
          ...
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="rounded-2xl overflow-hidden border border-gray-100 dark:border-white/8 bg-white dark:bg-[#0A0A0A]">
              ...
              <div className="p-5 space-y-3">
                <div className="h-3 bg-gray-200 dark:bg-white/10 rounded w-1/4 animate-pulse" />
                <div className="h-5 bg-gray-200 dark:bg-white/10 rounded w-5/6 animate-pulse" />
