                ...
                >
                    ...
                    <div className="flex gap-3 justify-center mt-6">
                        ...
                        <button
                            onClick={() => {
                                setSubmitted(false);
                                setFormData({ name: "", email: "", phone: "", company: "", city: "", state: "", message: "" });
                            }}
                        ...
                        <div className="bg-white dark:bg-[#0A0A0A] rounded-2xl shadow-lg dark:shadow-none border border-gray-100 dark:border-white/10 p-6 space-y-6">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:contact@garudaqua.in" className="text-sm text-gray-600 dark:text-gray-400 font-light hover:text-[#0EA5E9] transition-colors">
                                        contact@garudaqua.in
                                    </a>
                                </div>
                            </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            className="w-full px-4 py-3 border border-gray-300 dark:border-white/20 rounded-xl bg-white dark:bg-white/5 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-[#0EA5E9] focus:border-transparent transition"
                                        >
