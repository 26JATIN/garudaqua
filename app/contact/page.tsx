        ...
        return (
            <div className="min-h-screen bg-gray-50 dark:bg-black flex items-center justify-center px-4">
                ...
                >
                    ...
                    <a href="https://maps.app.goo.gl/LH69FP4CLybZSRAX7" target="_blank" rel="noopener" className="inline-block mt-2 text-[#0EA5E9] hover:underline font-medium">View Our Location on Google Maps</a>
