    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-[#060606] md:py-4">
            ...
            <div className="relative overflow-hidden bg-linear-to-br from-[#0c1a2e] via-[#0f2440] to-[#0a1628] ">
                ...
                <div className="relative max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 md:py-28 text-center">
            ...
            {/* Categories Grid */}
            <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 md:py-20">
                {/* Section label */}
